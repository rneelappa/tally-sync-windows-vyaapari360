...
async function debugLedgerParsing() {
  const TALLY_URL = 'https://e34014bc0666.ngrok-free.app';
  
  console.log('🔄 Testing List of Accounts parsing with exact server logic...');
...
<ENVELOPE>
  ...
  try {
    ...
    console.log(`🎯 Final result: ${ledgers.length} ledgers extracted`);
